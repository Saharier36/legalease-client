    ...
    <Modal isOpen={isOpen} isDismissable={false} hideCloseButton>
      <Modal.Backdrop className="bg-black/80 backdrop-blur-md">
        <Modal.Container className="flex items-center justify-center p-4">
          <Modal.Dialog className="bg-zinc-950/90 border border-white/10 rounded-none w-full max-w-md p-6 shadow-2xl relative overflow-hidden before:absolute before:top-0 before:left-0 before:w-full before:h-0.5 before:bg-[#A3F367]">
            <Modal.Header className="text-center flex flex-col items-center gap-1 pt-4">
              <Modal.Heading className="font-header text-2xl font-extrabold tracking-wide text-white">
            ...
            <Modal.Body className="py-6 flex flex-col gap-4">
              ...
              <button
                ...
                className="w-full text-left p-4 bg-white/5 border border-white/10 hover:border-[#A3F367]/50 hover:bg-white/10 transition-all duration-200 flex items-center gap-4 group"
              >
                <div className="p-3 bg-white/5 text-slate-400 group-hover:text-[#A3F367] group-hover:bg-[#A3F367]/10 transition-colors">
